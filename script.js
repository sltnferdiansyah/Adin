...
footer.href = "https://www.instagram.com/sltnferdiansyah/";

document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire("Hallo Sayang", "Perdi ada pertanyaan nih buat Adin?", "question").then(function () {
    Swal.fire("Jawab yang jujur ya!").then(function () {
      Swal.fire("Awas aja kalo boong!!", "", "error").then(function () {
        ...
        const {
          ...
          title: 'Ini Adin apa bukan?',
          confirmButtonText: `Iyaa ini Adin`,
        }).then(function () {
